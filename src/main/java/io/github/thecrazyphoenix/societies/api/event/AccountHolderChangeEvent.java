 ...
 */
public interface AccountHolderChangeEvent extends Event, Cancellable {
    /**
     ...
     */
    interface Create extends AccountHolderChangeEvent {}

    /**
     * Called when an AccountHolder is destroyed.
     */
    interface Destroy extends AccountHolderChangeEvent {}
}
